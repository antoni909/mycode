...
curl http://0.0.0.0:2224 -L
curl http://0.0.0.0:2224/login -d "username=cupcake" -L
curl http://0.0.0.0:2224/login -d "username=admin" -L

curl http://0.0.0.0:2224/slow
curl http://0.0.0.0:2224/fast
curl http://0.0.0.0:2224/ping
